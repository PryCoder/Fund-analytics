...
import { LayoutDashboard, TrendingUp, BarChart3, Sparkles, Menu, X, Bookmark } from 'lucide-react'
      ...
      >
        ...
        <div className="border-b border-white/10 px-5 py-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-sm font-semibold tracking-tight text-white">Aureva Fund</h2>
              <p className="text-[11px] text-gray-500">Mutual Fund Analytics</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto px-3 py-6">
          <div className="mb-4 px-3">
            <p className="text-[10px] font-medium uppercase tracking-wider text-gray-500">Menu</p>
          </div>
          ...
          <div className="mt-8 mx-3 rounded-xl border border-white/10 bg-white/5 p-4">
            ...
            <h3 className="text-sm font-medium text-white">NAV Analytics</h3>
